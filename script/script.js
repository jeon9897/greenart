...
document.getElementById('contactForm').addEventListener('submit', function (e) {
    e.preventDefault(); // 기본 폼 제출(새로고침) 막기
    ...
    // 🌟 Google 웹 앱 URL
    const gasURL = 'https://script.google.com/macros/s/AKfycbzBXSe6bh3o0J6taoABOU7qvVSuBDPr3V_DcWMqfufN0uMj1kh8gYtZk2LaeyHVFvZhFA/exec';

    // 폼 데이터를 URL 인코딩 형태로 변환
    ...
    fetch(gasURL, {
        ...
        .then(data => {
            if (data.result === 'success') {
                alert('작성하신 상담문의 글이 성공적으로 전송되었습니다!\n담당자가 확인 후 연락드리겠습니다.');
